            ...
            <div className="flex flex-col md:flex-row gap-4">
                        ...
                        <div className="flex-auto">
                          <div className="float-right">
                            <a
                              ...
                              onClick={() =>
                                deleteItemFromCart(cartItem?.key)
                              }
                            >
                              Remove
                            </a>
              ...
              <aside className="md:w-1/4">
                <article className="border border-gray-200 bg-white shadow-sm rounded mb-5 p-3 lg:p-5">
                  ...
                  <Link href='/checkout' className="px-4 py-3 mb-2 inline-block text-lg w-full text-center font-medium text-white bg-green-600 border border-transparent rounded-md hover:bg-green-700 cursor-pointer">
                    Continue
                  </Link>
