...
<footer className="bg-primary mt-10">
    ...
    <div className="px-4 py-6 bg-red-600 md:flex md:items-center md:justify-between">
        <span className="text-sm text-gray-300 sm:text-center">© 2023 <a href="/">JFood™</a>. All Rights Reserved.
        </span>
